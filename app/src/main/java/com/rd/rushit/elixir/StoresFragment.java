...
public class StoresFragment extends Fragment {
    ...
    String url = "http://prabhutibuildcone.co.in/elixir/store.php";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.storesfragment, container, false);
    ...
    public void onResume() {
        super.onResume();
        ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle("Medical Stores");
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null)
                ...
                vi = inflater.inflate(R.layout.custom_store, null);
